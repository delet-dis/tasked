...
1. Clone forked repository `git clone git@github.com:YOUR-USERNAME/tasked.git`

All changes should be based on the `main` branch. Push to your fork and [submit a pull request](https://github.com/delet-dis/tasked/compare) against the `main` branch.
